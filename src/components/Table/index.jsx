...
const CardTable = ({ dataCardTable }) => {
	...
	return (
		<div className='font-medium flex pl-4 py-4 items-center border-b'>
			...
			<div className='w-3/12 flex justify-center'><UserCard dataUserCard={dataCardTable.user} /></div>
			<div className='w-2/12 flex items-end justify-center'><ProgressBar progress={dataCardTable.progress} /></div>
			<div className='w-1/12 flex justify-center'><a href={dataCardTable.linkDrive} target="_blank" rel="noopener noreferrer" className='inline-block text-center'><BsFolderSymlink fontSize={20} /></a></div>
